...
function onTick()
    ...
    table.insert(history, math.cos(10 * tau * ticks / 60) * math.cos(2 * tau * ticks / 60))
...
function onDraw()
    ...
    if mi then
        ...
        for n = 1, #history2-1 do
            ...
            -- logarithmic scale
            -- screen.drawLine(n, height-factor*math.log(history2[n]-mi), (n+1), height-factor*math.log(history2[n+1]-mi))
        end
